  ...
  const StyledTableRow = styled(TableRow)(({ theme }) => ({
    ...
    console.log(activity);
      ...
      const handleViewPdf = async (activityName, id) => {
        try {
          ...
          if(userRole === "PROFESSOR"){
            response = await axios.get('http://localhost:8080/professor/activities/justification', {
              responseType: 'blob',
            ...
            response = await axios.get('http://localhost:8080/commission/activities/justification', {
              responseType: 'blob',
      ...
      const handleValidate = async () => {
        try {
          const response = await axios.patch('http://localhost:8080/commission/activities/validate',{}, {
            params: {
      ...
      const handleCancel = async() => {
        try {
          const response = await axios.patch('http://localhost:8080/commission/activities/cancel',{}, {
            params: {
             activityName: activity.activityName,
             id: activity.id
          },
