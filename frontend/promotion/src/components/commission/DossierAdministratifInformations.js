...
export default function DossierAdministratifInformations () {
   ...
   const handleViewPdf = async (namePdf) => {
    try{
        ...
        if(namePdf ==="equivalence"){
            response = await axios.get('http://localhost:8080/commission/get-equivalence', {
                responseType: 'blob',
            ...
            response = await axios.get('http://localhost:8080/commission/get-cv', {
                responseType: 'blob',
                params: {id: professorFolder.folder_id , userEmail: prof.email },
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
            ...
            response = await axios.get('http://localhost:8080/commission/get-application-demande', {
                responseType: 'blob',
                params: {id: professorFolder.folder_id, userEmail: prof.email},
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
            ...
            response = await axios.get('http://localhost:8080/commission/get-phd-diplome', {
                responseType: 'blob',
                params: { id: professorFolder.folder_id, userEmail: prof.email},
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
            ...
            response = await axios.get('http://localhost:8080/commission/get-habilitation-diplome', {
                responseType: 'blob',
                params: { id: professorFolder.folder_id, userEmail: prof.email},
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
            ...
            response = await axios.get('http://localhost:8080/commission/get-arret-nomination', {
                responseType: 'blob',
                params: { id: professorFolder.folder_id, userEmail: prof.email},
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
            ...
            response = await axios.get('http://localhost:8080/commission/get-attestation', {
                responseType: 'blob',
                params: { id: professorFolder.folder_id, userEmail: prof.email},
                headers: {
                  'Authorization': 'Bearer ' + localStorage.getItem('token'),
  ...
  useEffect(() => {
    const getDossierAdministratif= async () => {
      try {
        const response = await axios.get('http://localhost:8080/commission/get-professor-folder', {
